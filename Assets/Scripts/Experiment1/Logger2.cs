...
class DataItem<T>
{
  string name;
  T item;
  public DataItem(string a_name, T a_item)
  {
    name = a_name;
    item = a_item;
  }
...
// class DataTransform : DataItem<Transform>
// {
//   public DataTransform
// }

public class DataLogger2 : SingletonMonoBehaviour<DataLogger2> // シングルトンは調べてください
{
  // データ保持用構造体
  public struct Data
  {
